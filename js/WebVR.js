...
var WEBVR = {
  isEnabled: false,
  createButton: function(camera, renderer, options) {
    ...
    function showEnterVR(device) {
      ...
      button.onclick = function() {
        this.isEnabled = !this.isEnabled;
        renderer.vr.enabled = this.isEnabled;
        device.isPresenting
          ? device.exitPresent()
    ...
    if ("xr" in navigator || this.isEnabled) {
      var button = document.createElement("button");
      ...
      return button;
    } else if ("getVRDisplays" in navigator || this.isEnabled) {
      var button = document.createElement("button");
      button.style.display = "none";
      ...
      message.innerHTML = "Click to view in VR";
